...
LEFT_MARGIN =  4 * SPRITE_PIXEL_SIZE * SPRITE_SCALING

# Physics
MOVEMENT_SPEED = 35 * SPRITE_SCALING
JUMP_SPEED = 16 * SPRITE_SCALING
GRAVITY = 0.8* SPRITE_SCALING
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        wall.boundary_left = 20000 * GRID_PIXEL_SIZE
        wall.boundary_right = 5000 * GRID_PIXEL_SIZE
        ...
        wall.boundary_left = 9 * GRID_PIXEL_SIZE
        wall.boundary_right = 9 * GRID_PIXEL_SIZE
        wall.change_x = 5 * SPRITE_SCALING
        ...
        wall.change_y = 5 * SPRITE_SCALING
        ...
        wall.boundary_right = 20 * GRID_PIXEL_SIZE
        ...
        arcade.set_background_color(arcade.color.GOLD_FUSION)
